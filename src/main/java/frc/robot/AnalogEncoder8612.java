/*
 * Copied from WpiLib so I could control how the AnalogTrigger is setup and debug
 * 
 */
...
public class AnalogEncoder8612 implements Sendable, AutoCloseable {
   ...
   */
  public AnalogEncoder8612(int channel) {
  ...
  public AnalogEncoder8612(AnalogInput analogInput) {
  ...
  private void init() {
    ...
    // m_analogTrigger.setAveraged(true);
    m_analogTrigger.setFiltered(true);
