...
public class AimAndShoot extends SequentialCommandGroup {
    ...
    public AimAndShoot(Arm arm, Drivetrain drivetrain, TagLimelight tagLimelight, AimRotation aimRotation, AimArm aimArm, ShooterSpinUp shooterSpinUp, ShootSpeaker shootSpeaker) {
        super();
        this.arm = arm;
